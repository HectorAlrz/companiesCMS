                ...
                <div>
                    <div className='flex flex-wrap sm:flex-nowrap justify-center sm:justify-between   p-2 sm:p-3'>
                        ...
                        <div className='flex justify-center mr-2'>
                            <img className='object-fit border-2 w-100px h-100px ' src='https://pbs.twimg.com/profile_images/1389265488836890624/8u5wEQ9Z_400x400.png' alt='img' />
                        </div>
                        ...
                        <div className='flex flex-col justify-between content-center sm:w-392px '>
                            ...
                            <p className='text-xs sm:text-left'>"Coinbase is an online platform that allows merchants, consumers, and traders to transact with digital currency."</p>
                        </div>
